    ...
    <section className="">
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <div className="d-flex badge-bar">
              <div className="badge-item me-2">
                <Badge bg="secondary">C#.NET Core</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">.NET Core / 6+</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">MVC</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">Javascript | jQuery</Badge>
              </div>
              <div className="badge-item me-2">
              ...
              <div className="badge-item me-2">
                <Badge bg="secondary">EntityFramework</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">HTML5</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">CSS | SCSS</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">Azure DevOps</Badge>
              </div>
            </div>
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <div className="d-flex badge-bar">
              <div className="badge-item me-2">
                <Badge bg="secondary">C#.NET</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">MVC</Badge>
              </div>
              ...
              <div className="badge-item me-2">
                <Badge bg="secondary">nHibernate</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">EntityFramework</Badge>
              </div>
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            <div className="d-flex badge-bar">
              ...
              <div className="badge-item me-2">
                <Badge bg="secondary">WebForms</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">Javascript | jQuery</Badge>
              </div>
        ...
        <Accordion.Item eventKey="3">
          ...
          <Accordion.Body>
            <div className="d-flex badge-bar">
              <div className="badge-item me-2">
                <Badge bg="secondary">VB.NET</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">Windows Forms</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">SQL</Badge>
              </div>
        ...
        <Accordion.Item eventKey="4">
          ...
          <Accordion.Body>
            <div className="d-flex badge-bar">
              <div className="badge-item me-2">
                <Badge bg="secondary">.NET Blazor</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">SQL Express</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">NodeJS / Express</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">MongoDB</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">Blender 3.0</Badge>
              </div>
              <div className="badge-item me-2">
                <Badge bg="secondary">ThreeJS</Badge>
              </div>
              <div className="badge-item me-2">
